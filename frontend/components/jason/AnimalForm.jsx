    ...
    return (
      <form method="POST" action="/animals/react_create">
        ...
        <label>
          Is vaccinated:
          <input
            // required for rails to parse checkbox false value correctly
            type="hidden"
            value="0"
          ...
          <input
            name="animal[is_vaccinated]"
            // won't work without this id= field when rails parses parameters
            // (just copying the html generated by erb f.check_box)
