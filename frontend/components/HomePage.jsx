  ...
  render() {
    return (
      <div>
        ...
        <p>The system has background recurring jobs that make the system record the data for events including:
          <ul>
            <li>New Animal given to shelter</li>
            <li>Animal gets adopted by Person</li>
            <li>Animal that is already adopted is given a Toy</li>
            <li>Oldest of adopted Animal dies, freeing up a position for a new AnimalAdoption</li>
          </ul>
        </p>
      </div>
    );
