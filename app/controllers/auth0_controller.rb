class Auth0Controller < ApplicationController
  def callback
    ...
    # (retrieved by omniauth-auth0) in request.env['omniauth.auth'].
    # In this tutorial, you will store that info in the session, 
    # under 'userinfo'.
    # If the id_token is needed, you can get it from 
